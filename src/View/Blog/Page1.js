...
import Bi1 from "../../images/blog-img-1.jpg";
import Bi2 from '../../images/blog-img-2.jpg';
            ...
            <div className="col-xl-8 col-lg-8 col-md-12 col-12">
              <div className="page_left mb-5">
                ...
                <div className="blog_cnt">
                  ...
                  <button className="read_btn" onClick={toggleReadMoreLess}> {isShowMore ? "Read Less" : "Read More"}</button>
                </div>
              </div>
              ...
              <div className="page_right">
                ...
                <div className="heading">
                  ...
                  <div className="flw_icon">
                    <a href="#" className="social_ntw"><i className="fa-brands fa-twitter"></i></a>
                    <a href="#" className="social_ntw"><i className="fa-brands fa-pinterest-p"></i></a>
                    <a href="#" className="social_ntw"><i className="fa-brands fa-facebook-f"></i></a>
                    <a href="#" className="social_ntw"><i className="fa-brands fa-instagram"></i></a>
                  </div>
                </div>
              </div>
            </div>
